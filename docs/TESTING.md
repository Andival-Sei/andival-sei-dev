...
> **Текущий этап:** Этап 1 полностью завершен - UI components 100% ✅  
> **Покрытие кода:** 25.37% (было 18.57%) → Цель: 80%+
...
```
Всего тестов: 322 | Файлов с тестами: 11 | Покрытие: 25.37%
```
...
- **Компоненты:** ProjectCard, ProjectsFilters, ParticleAnimation
- **Секции:** Hero, TechStack, FeaturedProjects
...
### 2.2 Компоненты проектов

#### ProjectCard (`src/components/project-card.tsx`)

- [ ] Рендеринг компонента
- [ ] Отображение названия и краткого описания
- [ ] Медиа превью (video/image с fallback)
- [ ] Теги технологий (Badge компоненты)
- [ ] Тип проекта (commercial/personal/educational)
- [ ] Ссылка на детальную страницу (/projects/[id])
- [ ] Hover эффекты (масштабирование, overlay)
- [ ] Адаптивный дизайн
- [ ] Accessibility (aria-labels, alt текст)
...
- [ ] Рендеринг компонента
- [ ] Поиск по названию (Input с onChange)
- [ ] Debounce для поиска (проверить задержку)
- [ ] Фильтр по технологиям (Checkbox группа)
- [ ] Фильтр по типу проекта (Select: Все/Commercial/Personal/Educational)
- [ ] Сортировка по дате (Toggle: новые первыми/старые первыми)
- [ ] Callback функции вызываются с правильными параметрами
...
- [ ] Рендеринг компонента
- [ ] Заголовок "Andival-Sei" отображается
- [ ] Подзаголовок "Frontend-разработчик"
- [ ] Краткое описание (2 абзаца)
- [ ] CTA кнопка "Посмотреть проекты" с ссылкой на /projects
- [ ] CTA кнопка "Отправить Email" с mailto: ссылкой
- [ ] Правильные aria-labels
- [ ] Адаптивный дизайн (колонки на desktop)
...
| 2    | Проектные компоненты    | 0%      | 100%    |
| 3    | Секции главной страницы | 0%      | 90%     |
...
- **Текущее покрытие:** 25.37% (↑ с 18.57%)
- **После Этапа 1-2:** ~35% (Этап 1 завершен ✅)
- **После Этапа 3-4:** ~55%
- **После Этапа 5-6:** **80%+** ✅
- **Финальная цель:** 85%+
...
| ---- | ---------------------------- | ------ | -------- |
| 1    | UI компоненты                | ✅     | 100%     |
| 2    | Layout и основные компоненты | 🟡     | 50%      |
| 3    | Секции главной страницы      | ❌     | 0%       |
| 4    | Lab компоненты               | ❌     | 0%       |
| 5    | Страницы приложения          | ❌     | 0%       |
| 6    | Утилиты и данные             | 🟡     | 25%      |
| 7    | E2E тесты                    | ❌     | 0%       |

**Общий прогресс unit-тестов:** ~25% → Цель: 80%+
...
2. [ ] **Этап 2.2** - Покрыть ProjectCard и ProjectsFilters
3. [ ] **Цель покрытия:** 35%+
