...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(styles.dropdownMenuItem, inset && styles.dropdownMenuItemInset, className)}
    {...props}
  />
));
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(styles.dropdownMenuLabel, inset && styles.dropdownMenuItemInset, className)}
    {...props}
  />
));
